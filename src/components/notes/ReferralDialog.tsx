...
import { FileHeart, Download, Printer, CalendarIcon } from 'lucide-react';
import { useAuth } from '@/contexts/AuthContext';
import { toast } from 'sonner';
import { generateReferralLetterPDF } from '@/lib/pdfGenerator';
...
export const ReferralDialog = ({
  ...
  const [referralDate, setReferralDate] = useState<Date>(new Date());
  ...
  const handleGeneratePDF = async () => {
    ...
    const pdf = await generateReferralLetterPDF(
      {
        name: patient.name,
    ...
    pdf.save(`ReferralLetter_${patient.name}_${patient.surname}.pdf`);
    toast.success('Referral letter PDF generated successfully');
  };
        ...
        <div className="space-y-6 mt-4">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  ...
                  >
                    ...
                    {referralDate ? format(referralDate, "yyyy-MM-dd") : <span>Pick a date</span>}
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-auto p-0" align="start">
                  <Calendar
                    ...
                    onSelect={(date) => date && setReferralDate(date)}
                    initialFocus
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Enter clinical notes and referral details..."
              className="min-h-[250px] bg-muted/50 font-mono"
            />
          </div>
